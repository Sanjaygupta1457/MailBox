...
const Sent = () => {
  ...
  useEffect(() => {
    fetch(
      `https://mailbox-client-cae18-default-rtdb.firebaseio.com/${username}/sent.json`
    )
      .then((res) => {
        return res.json();
      })
  ...
  const deleteHandler = (key) => {
     fetch(`https://mailbox-client-cae18-default-rtdb.firebaseio.com/${username}/sent/${key}.json`, {
        method: "DELETE",
    }).then((res) => {
