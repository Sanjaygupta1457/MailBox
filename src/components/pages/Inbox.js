...
const Inbox = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://mailbox-client-cae18-default-rtdb.firebaseio.com/${username}/receiver.json`
    )
      .then((res) => {
        return res.json();
      })
  ...
  const deleteHandler = (key) => {
     fetch(`https://mailbox-client-cae18-default-rtdb.firebaseio.com/${username}/receiver/${key}.json`, {
        method: "DELETE",
    }).then((res) => {
