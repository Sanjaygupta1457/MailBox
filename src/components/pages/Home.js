...
const Home = () => {
  ...
  const formHandler = (e) => {
    ...
    fetch(`https://mailbox-client-cae18-default-rtdb.firebaseio.com/${username}/sent.json`, {
        method: "POST",
    ...
    fetch(`https://mailbox-client-cae18-default-rtdb.firebaseio.com/${userReceived}/receiver.json`, {
        method: "POST",
